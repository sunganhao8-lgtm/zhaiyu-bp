...
`+e.stack:e)}}function L0(i){let e=i.tagName.toLowerCase(),t=i.id?`#${i.id}`:"",n=i.getAttribute("class")||"",s=n?`.${n.trim().replace(/\s+/g,".")}`:"";return`<${e}${t}${s}>`}var vn={enabled:!0,angle:34,brightness:1450,color:"#ff9b45"},tc=["#ff9b45","#ffd89a","#f06d3d","#55c9ff","#ad78ff"],D0={\u670D\u52A1\u7834\u51B0:"\u5148\u89E3\u51B3\u4E00\u4E2A\u660E\u786E\u7684\u5C0F\u9EBB\u70E6\uFF0C\u5BA2\u6237\u624D\u613F\u610F\u8BF4\u51FA\u66F4\u591A\u771F\u5B9E\u9700\u6C42\u3002",\u53D1\u8A00\u5165\u5E93:"\u628A\u5BA2\u6237\u539F\u8BDD\u3001\u5BB6\u5EAD\u573A\u666F\u3001\u9884\u7B97\u4E0E\u72B9\u8C6B\u70B9\u6C89\u6DC0\u4E3A\u53EF\u590D\u76D8\u7684\u9700\u6C42\u8BC1\u636E\u3002",\u9700\u6C42\u590D\u76D8:"\u6BCF\u5468\u8BC6\u522B\u91CD\u590D\u51FA\u73B0\u7684\u95EE\u9898\uFF0C\u4E0D\u51ED\u611F\u89C9\u6269\u5F20\uFF0C\u53EA\u8FFD\u8E2A\u771F\u5B9E\u9AD8\u9891\u9700\u6C42\u3002",\u4EA7\u54C1\u5316:"\u628A\u9A8C\u8BC1\u8FC7\u7684\u9AD8\u9891\u9700\u6C42\u53D8\u6210\u5957\u9910\u3001\u6E05\u5355\u3001\u4E0A\u95E8 SOP\u3001\u4F1A\u5458\u6743\u76CA\u4E0E\u4EA7\u54C1\u3002"},ds=document.getElementById("experience"),jt=document.getElementById("lightCanvas"),Ht=document.getElementById("pageSurface"),N0=document.getElementById("sceneError");function jh(i,e){console.error(i,e||""),ds.classList.add("has-error"),ds.setAttribute("aria-busy","false"),N0.textContent=i}function U0(){if(window.__HTML_IN_CANVAS_POLYFILL__)for(let i of[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext]){if(!i)continue;let e=i.prototype,t=e.texElementImage2D;!t||t.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value(n,s,r,a,o,l){t.call(this,n,s,r,a,o,l)}})}}async function F0(){jt.setAttribute("layoutsubtree",""),$h(),U0(),await new Promise(Se=>requestAnimationFrame(Se));let i;try{i=new Mo({canvas:jt,antialias:!0,alpha:!1,powerPreference:"high-performance"})}catch(Se){jh("\u5F53\u524D\u6D4F\u89C8\u5668\u65E0\u6CD5\u521B\u5EFA WebGL \u573A\u666F\uFF0C\u5DF2\u4FDD\u7559\u9759\u6001\u9996\u9875\u3002",Se);return}i.outputColorSpace=Pt,i.toneMapping=js,i.toneMappingExposure=1.08,i.setClearColor(197379,1);let e=new Cs;e.background=new Fe(197379);let t=new Ct(37,1,.1,80),n=new pn;n.position.set(0,-.38,0),e.add(n);let s=new Os(Ht);s.colorSpace=Pt,s.minFilter=bt,s.magFilter=bt,s.generateMipmaps=!1;let r=new ni(1,1),a=new on({map:s,color:16777215,emissive:16777215,emissiveMap:s,emissiveIntensity:.34,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:mn}),o=new yt(r,a);n.add(o);let l=new yt(new ni(1.018,1.028),new on({color:525571,roughness:.92,metalness:.02}));l.position.z=-.035,n.add(l),e.add(new Ws(9070671,1051143,.5));let c=new $s(16765610,.18);c.position.set(-4.8,5.6,7.4),e.add(c);let u=new pn;e.add(u);let d=new L(0,4.72,1.18),h=1.22,p=1.18,x=new yt(new ss(.24,.3,.11,24),new on({color:1511437,roughness:.62,metalness:.72}));x.position.copy(d).add(new L(0,.08,0)),e.add(x);let M=new yt(new ss(.014,.014,1,10),new on({color:2366231,roughness:.5,metalness:.55}));e.add(M);let m=new pn;u.add(m);let f=[new we(.08,.08),new we(.18,.02),new we(.43,-.1),new we(.82,-.25),new we(1.08,-.36),new we(1.1,-.41)],b=new on({color:1511694,roughness:.34,metalness:.72,side:Qt}),C=new yt(new Vs(f,48),b);m.add(C);let y=new yt(new Hs(1.095,.027,8,48),new on({color:2759701,roughness:.28,metalness:.82}));y.rotation.x=Math.PI/2,y.position.y=-.397,m.add(y);let w=new on({color:new Fe(vn.color).multiplyScalar(.18),emissive:vn.color,emissiveIntensity:.42,roughness:.92,side:Qt}),S=new yt(new zs(1.055,48),w);S.rotation.x=Math.PI/2,S.position.y=-.385,m.add(S);let A=new on({color:16773597,emissive:vn.color,emissiveIntensity:3.2,roughness:.2}),_=new yt(new ks(.16,20,12),A);_.scale.y=1.2,_.position.y=-.33,m.add(_);let E=Ne(),R=new ts({map:E,color:vn.color,transparent:!0,opacity:.86,depthWrite:!1,blending:Qs}),I=new Ls(R);I.position.y=-.36,I.scale.set(.96,.96,.96),m.add(I);let N=new Ys(vn.color,1,18,Ti.degToRad(vn.angle),.88,2);N.power=vn.brightness,N.position.set(0,-.35,0),N.target.position.set(0,-7,0),m.add(N,N.target);let G=new Zs(vn.color,1,3.2,2);G.power=36,G.position.set(0,-.35,0),m.add(G);let W=new Eo;W.connect(i,t),W.add(o);let O=1/120,X=new L(0,-9.81,0),z=new L(.16,d.y-h,d.z+.08),K=z.clone().add(new L(.018,0,-.012)),te=new L(0,.3,.08),le=new L,he=te.clone(),me=new we,We=new Js,ct=new an(new L(0,0,1),-.08),Ve=new L(0,-1,0),J=new L(0,1,0),ie=Ve.clone(),ee=new L,Pe=new L,Le=new L,Ae=new L,ot=new L,Oe=new L,Ye=ie.clone(),Xe=new L,He=new Wt,dt=new Wt,pt=new Wt,mt=new L,rt=!1,tt=-1,ft=0,D=0,Mt=-1,Ze=0,T=vn.angle,g=!1,F=0,k=performance.now(),q=!1,ne=0,Q={...vn},Y=Ht.querySelector("#powerToggle"),Z=Ht.querySelector("#beamRange"),re=Ht.querySelector("#brightnessRange"),Me=Ht.querySelector("#beamOutput"),ce=Ht.querySelector("#brightnessOutput"),ae=Ht.querySelector("#colorOutput"),Ee=Ht.querySelector("#resetLight"),Ce=[...Ht.querySelectorAll("[data-color]")];function Ne(){let Se=document.createElement("canvas");Se.width=64,Se.height=64;let $e=Se.getContext("2d"),_t=$e.createRadialGradient(32,32,0,32,32,32);_t.addColorStop(0,"rgba(255,255,255,1)"),_t.addColorStop(.16,"rgba(255,222,172,.8)"),_t.addColorStop(.46,"rgba(255,154,69,.22)"),_t.addColorStop(1,"rgba(255,140,70,0)"),$e.fillStyle=_t,$e.fillRect(0,0,64,64);let Rn=new Fs(Se);return Rn.colorSpace=Pt,Rn}function P(){let Se=new Fe(Q.color),$e=Q.enabled?Q.brightness:0;N.color.copy(Se),N.power=$e,N.angle=Ti.degToRad(Q.angle),G.color.copy(Se),G.power=Q.enabled?36:0,A.emissive.copy(Se),A.emissiveIntensity=Q.enabled?3.2:.03,R.color.copy(Se),R.opacity=Q.enabled?.86:.08,w.emissive.copy(Se),w.emissiveIntensity=Q.enabled?.22+Q.brightness/7250:.03,Ht.style.setProperty("--lamp-color",Q.color),Z.value=String(Q.angle),re.value=String(Q.brightness),Me.textContent=`${Q.angle}\xB0`,ce.textContent=`${Q.brightness} lm`,ae.textContent=Q.color.toUpperCase(),Y.classList.toggle("is-on",Q.enabled),Y.setAttribute("aria-pressed",String(Q.enabled)),Y.querySelector("span").textContent=Q.enabled?"ON":"OFF",Ce.forEach(_t=>_t.classList.toggle("is-active",_t.dataset.color.toLowerCase()===Q.color.toLowerCase())),jt.requestPaint?.()}function se(){z.set(.16,d.y-h,d.z+.08),K.copy(z).add(new L(.018,0,-.012)),Ye.copy(ie)}function $(){Object.assign(Q,vn),P(),se()}Y.addEventListener("click",()=>{Q.enabled=!Q.enabled,P()}),Z.addEventListener("input",()=>{Q.angle=Number(Z.value),P()}),re.addEventListener("input",()=>{Q.brightness=Number(re.value),P()}),Ce.forEach(Se=>Se.addEventListener("click",()=>{Q.color=Se.dataset.color,P()})),Ee.addEventListener("click",$);let oe=Ht.querySelector("#conceptDescription");Ht.querySelectorAll("[data-concept]").forEach(Se=>Se.addEventListener("click",()=>{Ht.querySelectorAll("[data-concept]").forEach($e=>$e.classList.toggle("is-active",$e===Se)),oe.innerHTML=`<span>${Se.dataset.concept}</span>${D0[Se.dataset.concept]}`,jt.requestPaint?.()}));function ue(){let Se=Math.max(1,jt.clientWidth),$e=Math.max(1,jt.clientHeight),_t=Math.min(window.devicePixelRatio||1,Se<760?1.25:1.5);i.setPixelRatio(_t),i.setSize(Se,$e,!1),t.aspect=Se/$e,t.updateProjectionMatrix();let Rn=Ht.offsetWidth||1440,vr=Ht.offsetHeight||810,Gn=$e>Se*1.16,nn=Gn?7.2:12.8,Wn=nn*(vr/Rn);if(o.scale.set(nn,Wn,1),l.scale.set(nn,Wn,1),n.position.y=Gn?-.62:-.38,d.set(0,n.position.y+Wn/2+p,Gn?1.1:1.18),x.position.copy(d).add(new L(0,.08,0)),!rt){let fi=ee.copy(z).sub(d);fi.lengthSq()<.001&&fi.copy(Ve),fi.normalize().multiplyScalar(h),z.copy(d).add(fi),K.copy(z)}let yr=Wn+3.1,Mr=nn+1.25,di=Ti.degToRad(t.fov*.5),Sr=yr/(2*Math.tan(di)),Ri=Mr/(2*Math.tan(di)*t.aspect),br=Math.max(Sr,Ri);t.position.set(0,n.position.y-(Gn?.78:.62),br),t.lookAt(0,n.position.y+(Gn?-.04:.06),0),t.updateMatrixWorld(),W.update(),jt.requestPaint?.()}function j(Se){let $e=jt.getBoundingClientRect();me.x=(Se.clientX-$e.left)/$e.width*2-1,me.y=-((Se.clientY-$e.top)/$e.height)*2+1,We.setFromCamera(me,t)}function ve(Se){if(j(Se),!We.ray.intersectPlane(ct,te))return!1;mt.copy(z).project(t);let $e=(me.x-mt.x)*t.aspect,_t=me.y-mt.y;return ft=Ti.smoothstep(Math.sqrt($e*$e+_t*_t),.08,1.15),!0}function xe(Se){if(Se.button===2){Mt=Se.pointerId,Ze=Se.clientX,T=Q.angle,g=!1;return}Se.button!==0||Mt!==-1||Se.target instanceof Element&&Se.target.closest("[data-interactive],a,button,input,label")||ve(Se)&&(rt=!0,tt=Se.pointerId,Se.preventDefault(),D=performance.now(),he.copy(te),le.set(0,0,0),ds.classList.add("is-pulling"))}function ht(Se){if(Se.pointerId===Mt){let Rn=Se.clientX-Ze;!g&&Math.abs(Rn)>=4&&(g=!0),g&&(Q.angle=Ti.clamp(Math.round(T+Rn*.14),16,58),P());return}if(!rt||Se.pointerId!==tt||!ve(Se))return;let $e=performance.now(),_t=Math.max(.008,Math.min(.05,($e-D)/1e3));ee.copy(te).sub(he).multiplyScalar(1/_t),le.lerp(ee,.34),he.copy(te),D=$e}function Ke(Se){if(Se.pointerId===Mt){let $e=!g&&Se.type!=="pointercancel";if(Mt=-1,g=!1,$e){let _t=tc.indexOf(Q.color.toLowerCase());Q.color=tc[(_t+1)%tc.length],P()}return}!rt||Se.pointerId!==tt||(rt=!1,tt=-1,ds.classList.remove("is-pulling"),K.copy(z).addScaledVector(le,-O*.36))}function en(){Ae.copy(z).sub(K).multiplyScalar(rt?.985:.9948),K.copy(z),z.add(Ae).addScaledVector(X,O*O),rt&&(Pe.copy(te).sub(d).normalize(),Pe.lerp(Ve,1-ft*.82).normalize(),Le.copy(Pe).multiplyScalar(h).add(d).sub(z),ee.copy(z).sub(d).normalize(),Le.addScaledVector(ee,-Le.dot(ee)),z.addScaledVector(Le,52*O*O)),ee.copy(z).sub(d),ee.lengthSq()<1e-8&&ee.copy(Ve),ee.normalize().multiplyScalar(h),z.copy(d).add(ee)}function tn(){ot.copy(z).sub(d).normalize(),Xe.copy(d).add(z).multiplyScalar(.5),M.position.copy(Xe),M.scale.set(1,h,1),pt.setFromUnitVectors(J,ot),M.quaternion.copy(pt),rt?(Oe.copy(te).sub(z).normalize(),Ye.lerp(Oe,.32).normalize()):(He.setFromUnitVectors(Ve,ot),Oe.copy(ie).applyQuaternion(He).normalize(),Ye.lerp(Oe,.14).normalize()),dt.setFromUnitVectors(Ve,Ye),u.position.copy(z),u.quaternion.copy(dt)}function xr(Se){if(q)return;let $e=Math.min((Se-k)/1e3,.05);for(k=Se,F=Math.min(F+$e,O*5);F>=O;)en(),F-=O;tn(),W.update(),i.render(e,t),++ne===3&&(ds.classList.add("is-ready"),ds.setAttribute("aria-busy","false")),requestAnimationFrame(xr)}jt.addEventListener("pointerdown",xe),jt.addEventListener("dblclick",se),jt.addEventListener("contextmenu",Se=>Se.preventDefault()),window.addEventListener("pointermove",ht),window.addEventListener("pointerup",Ke),window.addEventListener("pointercancel",Ke),window.addEventListener("resize",ue),jt.addEventListener("paint",()=>{s.needsUpdate=!0}),window.addEventListener("pagehide",()=>{q=!0,W.disconnect(),i.dispose()},{once:!0}),P(),ue(),jt.requestPaint?.(),requestAnimationFrame(xr)}F0().catch(i=>jh("HTML-in-Canvas \u521D\u59CB\u5316\u5931\u8D25\uFF0C\u5DF2\u4FDD\u7559\u9759\u6001\u9996\u9875\u3002",i));
